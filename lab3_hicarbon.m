...
data = readmatrix('strainstress_hicarbon.txt');
...
% Elastic Modulus
proprng = data([data(:,1)>=0.045&data(:,1)<=0.135],:); %data in proportional range
...
text(Fu(1), Fu(2)+1000, 'ultimate stress', ...
    'FontSize', 8, ...
    'Color', 'Black', ...
    'VerticalAlign', 'bottom', ...
    'HorizontalAlign', 'center')
text(Ff(1)-0.02, Ff(2), 'fracture stress', ...
    'FontSize', 8, ...
    'Color', 'Black', ...
    'VerticalAlign', 'top', ...
    'HorizontalAlign', 'right')
text(EL(1), EL(2)-1000, 'elastic limit', ...
    'FontSize', 8, ...
    'Color', 'Black', ...
    'VerticalAlign', 'top', ...
    'HorizontalAlign', 'left')
text(Yu(1), Yu(2)+1000, 'upper yield point', ...
    'FontSize', 8, ...
    'Color', 'Black', ...
    'VerticalAlign', 'bottom', ...
    'HorizontalAlign', 'left')
text(Yl(1)+0.02, Yl(2), 'lower yield point', ...
    'FontSize', 8, ...
    'Color', 'Black', ...
    'VerticalAlign', 'middle', ...
    'HorizontalAlign', 'left')
text(PL(1)+0.02, PL(2), 'proportional limit', ...
    'FontSize', 8, ...
    'Color', 'Black', ...
    'VerticalAlign', 'top', ...
    'HorizontalAlign', 'left')

text(0.9, 30000, ['\sigma_u = ' num2str(Fu(2), '%.0f') ' psi'], ...
    'Color', 'Black', ...
    'HorizontalAlign', 'left')
text(0.9, 25000, ['\sigma_f = ' num2str(Ff(2), '%.0f') ' psi'], ...
    'Color', 'Black', ...
    'HorizontalAlign', 'left')
text(0.9, 20000, ['\sigma_y = ' num2str(Yu(2), '%.0f') ' psi'], ...
    'Color', 'Black', ...
    'HorizontalAlign', 'left')
text(0.9, 15000, ['\sigma_{pl} = ' num2str(PL(2), '%.0f') ' psi'], ...
    'Color', 'Black', ...
    'HorizontalAlign', 'left')
...
print(gcf(), '-dpdf', '-loose', 'Fig 1 - High Carbon.pdf');